...
public interface IEventService
{
    ...
    Task<EventResponse> UpdateEventAsync(string eventId, string? expectedVersion, UpdateEventRequest request, CancellationToken cancellationToken = default);
    Task DeleteEventAsync(string eventId, string? expectedVersion, CancellationToken cancellationToken = default);
